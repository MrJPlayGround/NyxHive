...
import type { NyxTask, TaskColumn, CreateTaskInput, TaskAssignee } from '@/lib/tasks-api'

const QUERY_KEY = ['nyx', 'tasks'] as const
const ASSIGNEES_KEY = ['nyx', 'tasks', 'assignees'] as const
...
export function TasksScreen() {
  ...
  const [editingTask, setEditingTask] = useState<NyxTask | null>(null)
  ...
  const tasksByColumn = useMemo(() => {
    const map: Record<TaskColumn, Array<NyxTask>> = {
