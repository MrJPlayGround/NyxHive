...
function readScheduleValue(job: NyxJob): string {
...
function getInitialState(job: NyxJob | null) {
          ...
          >
            ...
            >
              <div>
                ...
                >
                  Update the schedule, prompt, and routing for this Nyx task.
                </p>
              </div>
              <button
                type="button"
            ...
            <div className="flex-1 space-y-5 overflow-y-auto px-5 py-4">
              ...
              <section className="space-y-2">
                ...
                <textarea
                  ...
                  placeholder="What should Nyx do?"
                  required
                  rows={5}
                    ...
                    {DELIVERY_OPTIONS.map((option) => {
                      ...
                      return (
                        <button
                          ...
                          title={
                            needsGateway
                              ? `Requires Nyx Gateway with ${option} configured`
                              : undefined
                          }
