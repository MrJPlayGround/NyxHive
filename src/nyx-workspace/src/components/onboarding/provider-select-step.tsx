...
const PROVIDERS: Array<Provider> = [
  {
    ...
    placeholder: 'fake-anthropic-key',
  ...
  },
  {
    ...
    name: 'OpenRouter',
    description:
      'One Nyx connection to the models wired into this workspace. Ideal for flexibility and experimentation',
    badge: 'Popular',
    logo: <OpenRouterLogo className="size-8" />,
    placeholder: 'fake-openrouter-key',
