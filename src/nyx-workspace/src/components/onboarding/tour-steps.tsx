...
export const tourSteps: Array<Step> = [
  ...
  // Step 8: Terminal
  {
    ...
    content:
      `Built-in terminal for quick commands. Execute shell commands without leaving ${WORKSPACE_DISPLAY_NAME}.`,
  },
  ...
  // Step 10: Settings
  {
    ...
    content:
      `Configure providers, themes, accent colors, and more. Make ${WORKSPACE_DISPLAY_NAME} yours.`,
  },
  // Step 11: Finish
  {
    target: 'body',
    ...
    content:
      `Start chatting with ${WORKSPACE_AGENT_NAME}, explore the tools, and customize ${WORKSPACE_DISPLAY_NAME} to fit your workflow. Need help? Press ? to see all keyboard shortcuts.`,
  },
]
