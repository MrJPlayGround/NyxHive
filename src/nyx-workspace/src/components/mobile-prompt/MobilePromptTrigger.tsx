...
const MOBILE_ACCESS_DISMISSED_KEY = 'nyx-mobile-access-dismissed'
const MOBILE_PROMPT_DISMISSED_KEY = 'nyx-mobile-prompt-dismissed'
const MOBILE_SETUP_SEEN_KEY = 'nyx-mobile-setup-seen'
const LEGACY_MOBILE_ACCESS_DISMISSED_KEY = 'hermes-mobile-access-dismissed'
const LEGACY_MOBILE_PROMPT_DISMISSED_KEY = 'hermes-mobile-prompt-dismissed'
const LEGACY_MOBILE_SETUP_SEEN_KEY = 'hermes-mobile-setup-seen'
...
export function MobilePromptTrigger() {
  ...
  useEffect(() => {
    ...
    const isDismissed =
      localStorage.getItem(MOBILE_ACCESS_DISMISSED_KEY) === 'true' ||
      localStorage.getItem(MOBILE_PROMPT_DISMISSED_KEY) === 'true' ||
      localStorage.getItem(LEGACY_MOBILE_ACCESS_DISMISSED_KEY) === 'true' ||
      localStorage.getItem(LEGACY_MOBILE_PROMPT_DISMISSED_KEY) === 'true'
    const isSetup =
      localStorage.getItem(MOBILE_SETUP_SEEN_KEY) === 'true' ||
      localStorage.getItem(LEGACY_MOBILE_SETUP_SEEN_KEY) === 'true'
  ...
  const persistDismissalPreference = () => {
    if (dontShowAgain) {
      localStorage.setItem(MOBILE_ACCESS_DISMISSED_KEY, 'true')
      localStorage.removeItem(LEGACY_MOBILE_ACCESS_DISMISSED_KEY)
      localStorage.removeItem(LEGACY_MOBILE_PROMPT_DISMISSED_KEY)
    }
  }
            ...
            <div className="px-4 py-3">
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1 text-center">
                  ...
                  >
                    Connect your phone to this Nyx Workspace instance in a
                    few steps.
                  </p>
                </div>
